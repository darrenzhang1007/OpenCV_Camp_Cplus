...
int main(int argc, char** argv) {
	Mat background = imread("H:/OpenCV_Camp_Cplus/data/images/back_ground.jpg");
	VideoCapture capture;
	capture.open("H:/OpenCV_Camp_Cplus/data/images/greenscreen-asteroid.mp4");
	if (!capture.isOpened()) {
		printf("could not load video fl.._m.");
		return -1;
	}
